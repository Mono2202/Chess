...
bool BoardPosition::operator==(const BoardPosition& otherPos) const
{
...
/*
Checks whether the BoardPosition is out of bounds

Input:
None

Output:
true - the BoardPosition is out of bounds
false - otherwise
*/
bool BoardPosition::isOutOfBounds() const
{
